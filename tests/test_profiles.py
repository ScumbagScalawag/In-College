...
from tests.shared import fourAccounts, singleUser, emptyProfile  # needed for testWithDatabaseSet
...
def test_toDict():
    ...
    for key in profileDict:
        assert key in emptyProfile
        assert profileDict[key] == emptyProfile[key]
